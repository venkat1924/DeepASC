...
class Net(nn.Module):
    def __init__(self, scale=16, lstm=True, in_channels=2):
        ...
        self.conv1 = GluConv2d(in_channels=2, out_channels=scale, kernel_size=(1,3), stride=(1,2))
        self.conv2 = GluConv2d(in_channels=scale, out_channels=scale*2, kernel_size=(1,3), stride=(1,2))
        self.conv3 = GluConv2d(in_channels=scale*2, out_channels=scale*4, kernel_size=(1,3), stride=(1,2))
        self.conv4 = GluConv2d(in_channels=scale*4, out_channels=scale*8, kernel_size=(1,3), stride=(1,2))
        self.conv5 = GluConv2d(in_channels=scale*8, out_channels=scale*16, kernel_size=(1,3), stride=(1,2))
        
        self.glstm = GLSTM(groups=2) if lstm else None

        self.conv5_t_1 = GluConvTranspose2d(in_channels=scale*32, out_channels=scale*8, kernel_size=(1,3), stride=(1,2))
        self.conv4_t_1 = GluConvTranspose2d(in_channels=scale*16, out_channels=scale*4, kernel_size=(1,3), stride=(1,2))
        self.conv3_t_1 = GluConvTranspose2d(in_channels=scale*8, out_channels=scale*2, kernel_size=(1,3), stride=(1,2))
        ...
        self.conv5_t_2 = GluConvTranspose2d(in_channels=scale*32, out_channels=scale*8, kernel_size=(1,3), stride=(1,2))
        ...
        self.bn5 = nn.BatchNorm2d(scale*16)
                   
        self.bn5_t_1 = nn.BatchNorm2d(scale*8)
        self.bn4_t_1 = nn.BatchNorm2d(scale*4)
        self.bn3_t_1 = nn.BatchNorm2d(scale*2)
    ...
    def forward(self, x):
        ...
        out = self.glstm(out) if self.glstm is not None else out
